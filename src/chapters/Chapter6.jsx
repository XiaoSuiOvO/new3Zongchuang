  ...
  return (
    <section id="chapter6" className="chapter">
      <div className="chapter-container">
          ...
          <div className="data-card">
            ...
            <div className="chart-wrapper">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    data={entryPeriodData.map(d => ({ period: d.period, value: d.count2025 }))}
                    cx="50%" cy="50%"
                    ...
                    label={<RingLabel />}
                  >
                    {entryPeriodData.map((_, i) => (
                      <Cell key={i} fill={ringColors[i]} stroke="none" />
                    ))}
                  </Pie>
                  <Tooltip
                    contentStyle={{ background: '#1A1A1A', border: '1px solid rgba(212,168,67,0.4)', borderRadius: 8 }}
                    formatter={(value) => [`${value.toLocaleString()}万`, '党员数']}
                  />
                </PieChart>
              </ResponsiveContainer>
            </div>
        ...
        <p className="narrative-text" style={{ textAlign: 'center', maxWidth: '65ch', margin: '32px auto', fontSize: '1.1rem' }}>
          这片环形图里，<span className="hl">金色的那一圈</span>，是十八大以来入党的
          <span className="num">3018.7万人</span>——占全体党员的近三分之一。
          而在他们入党之前，有新中国成立前就加入的<span className="num">4.3万名</span>老党员，
          有社会主义建设时期加入的<span className="num">1167.4万人</span>，
          有改革开放后加入的<span className="num">5938.1万人</span>。
        </p>

        <p className="narrative-text" style={{ textAlign: 'center', maxWidth: '65ch', margin: '16px auto', fontSize: '1.1rem' }}>
          这四代人，见证了同一个组织在四个截然不同的时代里，如何不断自我更新。
          老党员慢慢老去，但新党员<span className="hl">以每年超过200万的速度涌入</span>——
          像潮水一样，一浪推着一浪。<br />
          <span className="hl">105年了，这个组织从来没有断过代。</span>
        </p>

        <p className="narrative-text" style={{ textAlign: 'center', maxWidth: '65ch', margin: '16px auto', fontSize: '1.1rem' }}>
          从1921年的<span className="num">58颗火种</span>，到2025年扎根各行各业的
          <span className="num">1亿余面旗帜</span>，这一路走了105年。
          而<span className="hl">下一个105年写什么——取决于今天正在看这行字的你。</span>
        </p>
        ...
        <div className="callout-box" style={{ textAlign: 'center' }}>
          <p style={{ fontSize: '1.15rem', lineHeight: 2 }}>
            ...
            <span style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
              ...
              选择一种信仰，然后用一生去践行它。<br />
              一百年前有人做出了这个选择。<br />
              一百年后——<span className="hl">轮到你了。</span>
            </span>
          </p>
        </div>
      </div>
